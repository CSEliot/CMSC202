...
public class Rectangle 
{
	...
	public Rectangle (Point upperLeft, Point lowerLeft, Point lowerRight, Point upperRight) throws Exception{
		if(!(upperLeft.x == lowerLeft.x && upperLeft.y == upperRight.y)){
			System.out.println("UpperLeft Fail: "+ upperLeft.x +" "+ upperRight.x);
			System.out.println("UpperLeft Fail: "+ upperLeft.y +" "+ lowerLeft.y);
			throw new Exception();
		}
		if(!(lowerRight.x == upperRight.x && lowerRight.y == lowerLeft.y)){
			System.out.println("LowerRight Fail");
			throw new Exception();
		}
